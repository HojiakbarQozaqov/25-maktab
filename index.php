...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
            ...
            <h3 class="navbar-brand logo-image q" href="index.html">25-Maktab</h3>
                ...
                <div class="swiper-container image-slider-1">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <img class="img-fluid" src="/images/room.jpg" alt="alternative" height="560px">
                        </div>
                        <!-- end of slide -->

                        <!-- Slide -->
                        <div class="swiper-slide">
                            <img class="img-fluid" src="images/IMG_0870.JPG" alt="alternative">
                        </div>
                        <!-- end of slide -->

                        <!-- Slide -->
                        <div class="swiper-slide">
                            <img class="img-fluid" src="images/IMG.JPG" alt="alternative">
                        </div>
                        <!-- end of slide -->
    ...
    <div class="slider-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>O'qituvchilardan yo'llangan xabarlar</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        <h2>25-Noyabr</h2>
                        <p>Bizning maktab qayta ta'mirlashda chiqdi va 2 hafta mobaynida maktab web dasturini yaratdik.
                             Bunda siz taklif va shikoyatlaringizni yozishingiz, yangiliklardan bo xabar bo'lishingiz mumkin.
                             Agar siz o'qituvchi bo'lsangiz accaunt ochib o'z yangiliklaringizni kiritishingiz mumkin bo'ladi</p>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div class="form-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>Tastiqlangan ustozlar uchun yangilik qo'shish <br> <span class="st">Iltimos email manzilingizni kiriting</span></h3>
                    <!-- Newsletter Form -->
                  <?
                   b_f();
                    ...
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">Izboskan tumani 25-MAKTAB</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-mobile-alt"></i>
                                <div class="media-body">+998 91 129 13 06 &nbsp;&nbsp;<i class="fas fa-mobile-alt"></i>&nbsp;+998 91 145 95 00</div>
                            </li>
                            <li class="media">
                              <i class="fas fa-globe"></i>
                                <div class="media-body"> <a class="light-gray" href="#your-link">Kundalik.com</a></div>
                            </li>
                        </ul>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="footer-col first">
                        <h5>Ne'matov Bahodirjon</h5>
                        <p class="p-small">25-maktabning sobiq o'quvchisi tomonidan  2023 yil may oyida dastur ishga tushdi
                            <br>
                          Ne'matov Bahodirjon:  +998 91 129 13 06
                        </p>
                    </div>
                </div> <!-- end of col -->
                <div class="col-md-3">
