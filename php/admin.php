  ...
  <body>
    <div class="sidebar">
      <div class="logo-details">
        ...
        <span class="logo_name">25-Maktab</span>
      </div>
      <ul class="nav-links">
        <li>
          <a href="#" class="bir">
            <i class='fas fa-edit'></i>
            <span class="links_name">Birinchi bo'lim</span>
          </a>
        </li>
        <li>
          <a href="#" class="sakkiz">
            <i class='fas fa-edit'></i>
            <span class="links_name">Ikkinchi bo'lim</span>
          </a>
        </li>
        <li>
          <a href="#" class="ikki">
        ...
        <li>
          <a href="#" class="olti">
            ...
            <span class="links_name">O'qituvchilar yangiliklari</span>
          </a>
        </li>
        <li>
          <?
          ...
          <a href="#" class="yetti">
            ...
            <span class="links_name"> Xabarlar <span class="badge badge-warning eye"><? if (!($r->cun == 0)) {
                                                                                        echo $r->cun;
                                                                                      } ?></span></span>
          </a>
        </li>
      ...
      <div class="home-content">
        <div class="sales-boxes">
          <div class="recent-sales box">
            ...
            <div class="olti_show">
              <div class="title">O'qituvchilar kiritgan yangiliklar</div><br>
              <?
              sel_tn();
              ?>
            </div>
