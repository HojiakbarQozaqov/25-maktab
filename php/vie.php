...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <span class="navbar-brand logo-image" style="color: black;" href="index.html">25-Maktab</span>
...
?>        
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="white" style="color: black;">Assalomu alaykum 25-maktabga xush kelibsiz</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
